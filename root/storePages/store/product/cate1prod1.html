              ...
              <div class="card_content">
                  ...
                  <div class="card_content_buying">
                    <div class="card_content_buying_option">
                      ...
                      <input type="number" min="1" placeholder="Quantity" value="1" id="product1_quantity">
                      <div class="card_content_buying_button">
                        <button id="add_product_to_cart1">Add to Cart</button> 
                        <button id="buy_now_product1">Buy Now</button>
                      </div>
                    </div>
