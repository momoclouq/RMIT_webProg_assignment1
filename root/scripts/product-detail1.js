...
//for php part, 
// addElementProduct1.addEventListener('click', showPopupSuccessAddToCart);
// buyNowElementProduct1.addEventListener('click', showPopupSuccessAddToCart);
...
//for php - section
let successMessage = document.querySelector(".successPopup");
setTimeout(()=>{
